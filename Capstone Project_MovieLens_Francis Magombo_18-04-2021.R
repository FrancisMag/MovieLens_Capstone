...
#Installing additional needed packages
...
#We will build and compare models using their resulting RMSE in order to assess find the best model among them. It is expected that we should at least have a RMSE lower than than 0.8775.

#Here is the function that computes the RMSE for vectors of ratings and their corresponding predictors:   RMSE <- function(predicted_ratings, true_ratings){ sqrt(mean((predicted_ratings - true_ratings)^2))


## Dataset for the analysis

#We will create a movie recommendation system using the 10M version of MovieLens dataset, collected by GroupLens Research.
...
#Predicted ratings and rmse results
...
#Choosing the most appropriate lambda
